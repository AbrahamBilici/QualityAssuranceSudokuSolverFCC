...
suite('Functional Tests', () => {
    ...
    test('Solve a puzzle with invalid characters: POST request to /api/solve', (done) => {
        const puzzle = '1.5..2.84..63.12.7.2..5.....9..10a..8.2.3674.3.7.2..9.47...8..1..16....926914.37.';
        chai.request(server)
            .post('/api/solve')
            .send({ puzzle })
            .end((err, res) => {
    ...
    test('Solve a puzzle that cannot be solved: POST request to /api/solve', (done) => {
        const puzzle = '77.89....75..7.3.4.2..4..1.5689..472...6..7..1.7.5.63873.1.2.8.6..47.1..2.9.387.6';
        chai.request(server)
            .post('/api/solve')
            .send({ puzzle })
            .end((err, res) => {
    ...
    test('Check a puzzle placement with invalid characters: POST request to /api/check', (done) => {
        const puzzle = '..9..5.1.85.4....2432..0...1a..69.83.9.....6.62.71...9......1945....4.37.4.3..6..';
        const coordinate = 'A1';
        const value = '5';
        chai.request(server)
            .post('/api/check')
